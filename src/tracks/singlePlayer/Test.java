...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // Nuestro controlador
        String controladorDijkstra = "tracks.singlePlayer.src_SANCHEZ_GUERRERO_ANGEL.AgenteDijkstra";
		...
		// Game and level to play - Labyrinth Dual (índice 59)
		int gameIdx = 59;
		...
		ArcadeMachine.runOneGame(game, level1, visuals, controladorDijkstra, recordActionsFile, seed, 0);
